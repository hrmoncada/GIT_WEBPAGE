...
% Again, the address lines must be centered over entire width of resume:
 \moveleft.5\hoffset\centerline{1469 Zepol Rd, Apt 110}
 \moveleft.5\hoffset\centerline{Santa Fe, NM 87507}
 \moveleft.5\hoffset\centerline{(915) 730-2550}
 \moveleft.5\hoffset\centerline{hrmoncada@lanl.gov/hrmoncada@gmail.com}
% Draw a horizontal line the whole width of resume:
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip
\begin{resume}
\section{OBJECTIVE} Application to Virgin Galactic 
%LANL Foreign Visitor Documents Renewal %ALCF Account Request: Foreign National Documents 
%Job application% for Postdoctoral Researcher 
% \section{STATUS}
% {\sl Peruvian citizen}\\
...
{\sl Postdoc Research, Los Alamos National Laboratory} %\hfill \\      
...
{\sl , Bioinformatics Department - UTEP} %\hfill \\      
\begin{itemize}\itemsep -2pt
